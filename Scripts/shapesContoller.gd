...
@export_range(1.0, 20.0, 0.5) var rotation_radius: float = 5.0  # Min 1, Max 20, Step 0.5
@export_range(0.0, 2.0, 0.1) var rotation_speed: float = 0.2    # Min 0, Max 2, Step 0.1
